...
const rawItems: ItemDefinition[] = [
  ...
  {
    id: "moor_thread",
    displayName: "Moor Thread",
    description: "Runed weaving. +10 ability power.",
    cost: 250,
  ...
  },
  {
    ...
    description: "Focused rune lens. +25 ability power.",
    cost: 650,
    stats: { abilityPower: 25 },
    buildsFrom: ["moor_thread"],
    category: "magic",
    sellRatio: 0.7,
  },
  {
    id: "thistleweave_cloak",
    displayName: "Thistleweave Cloak",
    description: "Woven against crown sorcery. +20 magic resist.",
    cost: 380,
  ...
  {
    id: "greystone_greaves",
    displayName: "Greystone Greaves",
    description: "Heavy moor greaves. +12 armor, +0.45 move speed.",
    cost: 700,
    stats: { armor: 12, moveSpeed: 0.45 },
    category: "movement",
    sellRatio: 0.7,
  },
  {
    id: "stagheart_relic",
    displayName: "Stagheart Relic",
    description: "Relic of the Elder Stag. +30 attack damage, +15 ability power, +80 health.",
    cost: 1200,
    stats: { attackDamage: 30, abilityPower: 15, maxHealth: 80 },
    buildsFrom: ["highland_iron", "moor_thread"],
    category: "attack",
    sellRatio: 0.7,
  },
];
